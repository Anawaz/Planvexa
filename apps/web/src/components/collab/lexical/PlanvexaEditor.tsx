...
import { DocumentImageProvider } from "./DocumentImageContext";
  ...
  return (
    ...
    >
      <LexicalCollaboration>
        <DocumentImageProvider documentId={documentId}>
          <div className="flex flex-col">
            <Toolbar readOnly={!canEdit} documentId={documentId} />
            <div className="relative min-h-[28rem] px-4 py-3">
              ...
              <LinkPlugin />
              <TablePlugin />
              <ImagePlugin documentId={documentId} />
              <MentionsPlugin />
              {onChange ? (
                <OnChangePlugin
