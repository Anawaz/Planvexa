...
export const planningKeys = {
  ...
  scheduledReports: () => [...planningKeys.all, "scheduled-reports"] as const,
  portfolios: () => [...planningKeys.all, "portfolios"] as const,
  portfolioEntity: (id: string) => [...planningKeys.portfolios(), id] as const,
  portfolioReport: (id: string, params: { from?: string; to?: string }) =>
    [...planningKeys.portfolioEntity(id), "report", params] as const,
};
