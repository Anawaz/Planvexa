...
public static class AutomationEndpoints
{
    ...
    private static void MapWebhooks(RouteGroupBuilder api)
    {
        ...
        group.MapPost("/{id:guid}/deliveries/{deliveryId:guid}/retry", async (Guid id, Guid deliveryId, WebhookService svc, CancellationToken ct) =>
            Results.Ok(await svc.RetryDeliveryAsync(id, deliveryId, ct)));
    }
