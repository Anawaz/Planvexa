...
/// <summary>Shared dependencies for Mobile application services.</summary>
public sealed class MobileServiceContext(
...
public abstract class MobileServiceBase(MobileServiceContext ctx)
{
    protected MobileServiceContext Ctx => ctx;
