...
public sealed record SprintDto(Guid Id, string Name, DateTimeOffset StartUtc, DateTimeOffset EndUtc, string Status, int TotalPoints);
...
public sealed record CreateSprintCommand(string Name, DateTimeOffset StartUtc, DateTimeOffset EndUtc);
