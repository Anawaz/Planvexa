...
/// <summary>Shared dependencies for Governance application services.</summary>
public sealed class GovernanceServiceContext(
...
public abstract class GovernanceServiceBase(GovernanceServiceContext ctx)
{
    protected GovernanceServiceContext Ctx => ctx;
