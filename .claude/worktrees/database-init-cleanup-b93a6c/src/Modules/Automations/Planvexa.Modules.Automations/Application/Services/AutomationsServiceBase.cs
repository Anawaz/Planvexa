...
/// <summary>Shared dependencies for Automations application services.</summary>
public sealed class AutomationsServiceContext(
...
public abstract class AutomationsServiceBase(AutomationsServiceContext ctx)
{
    protected AutomationsServiceContext Ctx => ctx;
