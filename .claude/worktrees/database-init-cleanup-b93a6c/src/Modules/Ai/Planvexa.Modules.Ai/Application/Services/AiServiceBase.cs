...
/// <summary>Shared dependencies for AI application services.</summary>
public sealed class AiServiceContext(
...
public abstract class AiServiceBase(AiServiceContext ctx)
{
    protected AiServiceContext Ctx => ctx;
