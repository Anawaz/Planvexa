...
/// NOT handle <see cref="CustomFieldType.User"/> (needs an async workspace-membership check — stays in
/// <c>CustomFieldService</c>) or <see cref="CustomFieldType.Relationship"/>/Formula/Rollup (never a plain
/// stored value — callers must reject those before calling this).
/// </summary>
