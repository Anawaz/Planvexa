...
public sealed record FolderDto(Guid Id, Guid SpaceId, Guid? ParentFolderId, string Name, double Position, bool IsPrivate, Guid? DefaultViewId);
...
public sealed record StatusDto(Guid Id, string Name, string Category, string Color, double Position);
...
public sealed record TaskDto(
    ...
    Guid? TaskTypeId, string? CustomId, IReadOnlyList<Guid> TeamAssigneeIds);
