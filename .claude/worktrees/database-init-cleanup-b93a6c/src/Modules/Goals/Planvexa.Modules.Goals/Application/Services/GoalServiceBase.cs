...
/// <summary>Shared dependencies for Goals application services (mirrors ReportingServiceContext/Base).</summary>
public sealed class GoalServiceContext(
...
public abstract class GoalServiceBase(GoalServiceContext ctx)
{
