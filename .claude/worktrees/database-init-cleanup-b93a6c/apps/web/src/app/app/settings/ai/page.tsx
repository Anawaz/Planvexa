...
import { getAiProviderSettings, testAiProviderSettings, updateAiProviderSettings } from "@/lib/ai/client";
...
const emptySettings: AiProviderSettings = { baseUrl: "", model: "", apiKeyMask: "", isEnabled: false };
...
export default function AiProviderSettingsPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: (settings) => {
      ...
      setDraft({ baseUrl: settings.baseUrl, model: settings.model, apiKey: "", isEnabled: settings.isEnabled });
