...
internal static class WorkMapper
{
    ...
    public static FolderDto ToDto(Folder f) => new(f.Id, f.SpaceId, f.ParentFolderId, f.Name, f.Position, f.IsPrivate, f.DefaultViewId, f.IsArchived);
    ...
    public static MyWorkPreferenceDto ToDto(MyWorkPreference p) => new(p.SortBy, p.HiddenSections);
    ...
    public static TaskDto ToDto(WorkItem t) => new(
        ...
        t.TaskTypeId, t.CustomId, t.TeamAssignees.Select(a => a.TeamId).ToList(), t.IsArchived, t.CreatedByUserId);
