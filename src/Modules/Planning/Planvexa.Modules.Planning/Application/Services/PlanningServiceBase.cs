...
/// <summary>Shared dependencies for Planning application services.</summary>
public sealed class PlanningServiceContext(
...
public abstract class PlanningServiceBase(PlanningServiceContext ctx)
{
    protected PlanningServiceContext Ctx => ctx;
