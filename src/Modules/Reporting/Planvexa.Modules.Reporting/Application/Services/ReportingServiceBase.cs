...
/// <summary>Shared dependencies for Reporting application services.</summary>
public sealed class ReportingServiceContext(
...
public abstract class ReportingServiceBase(ReportingServiceContext ctx)
{
    protected ReportingServiceContext Ctx => ctx;
